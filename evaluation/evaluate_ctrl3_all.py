...
def main():
    ...
    print ("ctrl_sent_answers")   
    with open('ctrl3_july.pkl', 'rb') as f:
        ctrl_answers = pickle.load(f)
    ctrl_scors = rouge_cos_all(ctrl_answers, df['Answers'].values)
    with open('ctrl_rcall_.pkl', 'wb') as f:
        pickle.dump(ctrl_scors, f)
